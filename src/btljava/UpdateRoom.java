...
public class UpdateRoom extends JFrame {
    ...
    public UpdateRoom() throws SQLException {
        ...
        ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("btljava/icons/seventh.jpg"));
        ...
        JLabel lblUpdateRoomStatus = new JLabel("Cập Nhật Trạng Thái Phòng");
        lblUpdateRoomStatus.setFont(new Font("Tahoma", Font.PLAIN, 20));
        lblUpdateRoomStatus.setBounds(85, 11, 300, 36);
        ...
        JLabel lblAvailability = new JLabel("Trạng Thái Phòng:");
        lblAvailability.setBounds(27, 187, 120, 14);
        contentPane.add(lblAvailability);

        JLabel lblCleanStatus = new JLabel("Tình Trạng Phòng:");
        lblCleanStatus.setBounds(27, 240, 120, 14);
