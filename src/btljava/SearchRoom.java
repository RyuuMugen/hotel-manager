...
public class SearchRoom extends JFrame {
    ...
    public SearchRoom() throws SQLException {
        ...
        JLabel lblSearchForRoom = new JLabel("Tìm Phòng");
        ...
        JLabel lblRoomAvailable = new JLabel("Loại Phòng:");
        lblRoomAvailable.setBounds(50, 73, 96, 14);
        contentPane.add(lblRoomAvailable);

        JLabel lblRoomType = new JLabel("Số Phòng");
        lblRoomType.setBounds(23, 162, 96, 14);
        contentPane.add(lblRoomType);

        JLabel lblRoomAvailable_1 = new JLabel("Tình Trạng Phòng");
        lblRoomAvailable_1.setBounds(145, 162, 120, 14);
        contentPane.add(lblRoomAvailable_1);

        JLabel lblPrice_1 = new JLabel("Giá Phòng");
        lblPrice_1.setBounds(458, 162, 70, 14);
        contentPane.add(lblPrice_1);

        JLabel l1 = new JLabel("Loại Phòng");
        l1.setBounds(580, 162, 96, 14);
        contentPane.add(l1);

        JCheckBox checkRoom = new JCheckBox("Chỉ hiện phòng còn chưa đặt");
        ...
        btnSearch.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String SQL2 = "select * from Room where availability = 'Chưa Đặt' AND bed_type = '"+c1.getSelectedItem()+"'";
                try{
        ...
        JLabel lblCleanStatus = new JLabel("Tình Trạng Vệ Sinh");
        lblCleanStatus.setBounds(290, 162, 120, 14);
