...
public class Room extends JFrame {
    ...
    public Room() throws SQLException {
        ...
        ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("btljava/icons/Room.jpg"));
        ...
        lblAvailability = new JLabel("Tình Trạng Phòng");
        lblAvailability.setBounds(90, 15, 120, 14);
        contentPane.add(lblAvailability);

        lblCleanStatus = new JLabel("Tình Trạng V.S");
        lblCleanStatus.setBounds(200, 15, 120, 14);
        contentPane.add(lblCleanStatus);

        lblNewLabel = new JLabel("Giá Phòng");
        lblNewLabel.setBounds(300, 15, 70, 14);
        contentPane.add(lblNewLabel);

        lblNewLabel_1 = new JLabel("Loại Phòng");
        lblNewLabel_1.setBounds(395, 15, 76, 14);
        contentPane.add(lblNewLabel_1);


        lblId = new JLabel("Số Phòng");
