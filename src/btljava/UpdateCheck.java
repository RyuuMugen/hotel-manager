...
public class UpdateCheck extends JFrame {
    ...
    public UpdateCheck() throws SQLException {
        ...
        ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("btljava/icons/nine.jpg"));
        ...
        JLabel lblNewLabel_4 = new JLabel("Phí đã trả: ");
        lblNewLabel_4.setBounds(25, 261, 107, 14);
        contentPane.add(lblNewLabel_4);

        JLabel lblNewLabel_5 = new JLabel("Phí Thanh Toán: ");
        ...
        btnUpdate.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                try{
                    ...
                    c.s.executeUpdate("update customer set room_number = '"+s2+"', name = '"+s3+"', status = '"+s4+"', deposit = "+s5+" where Id_number = "+s1);
