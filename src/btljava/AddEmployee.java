...
public class AddEmployee extends JFrame{ //Third Frame
    ...
    public AddEmployee(){
        ...
        JLabel Passportno = new JLabel("Mã Nhân Viên");
        ...
        JButton Next = new JButton("Lưu");
        Next.setBounds(200, 420, 150, 30);
        Next.setBackground(Color.BLACK);
        Next.setForeground(Color.WHITE);
        add(Next);

        JLabel Pnrno = new JLabel("Tên");
        ...
        JRadioButton NewRadioButton = new JRadioButton("Nam");
        ...
        JLabel Address = new JLabel("Công Việc");
        Address.setFont(new Font("Tahoma", Font.PLAIN, 17));
        Address.setBounds(60, 170, 150, 27);
        add(Address);

        String course[] = {"Lễ Tân","Mang Hành Lí","Dọn Phòng","Nhân Viên Nhà Bếp","Dịch Vụ Phòng","Phục Vụ Bàn","Quản Lí","Kế Toán","Đầu Bếp"};
        c1 = new JComboBox(course);
        c1.setBackground(Color.WHITE);
        c1.setBounds(200,170,150,30);
        add(c1);

        JLabel Nationality = new JLabel("Tuổi");
        ...
        JLabel AddPassengers = new JLabel("Thêm Nhân Viên");
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("btljava/icons/tenth.jpg"));
