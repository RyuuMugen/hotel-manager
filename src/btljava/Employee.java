...
public class Employee extends JFrame {
    ...
    public Employee() throws SQLException {
        ...
        lblNewLabel.setBounds(30, 11, 100, 14);
        contentPane.add(lblNewLabel);

        lblJob = new JLabel("Tên");
        lblJob.setBounds(159, 11, 46, 14);
        contentPane.add(lblJob);

        lblName = new JLabel("Giới Tính");
        lblName.setBounds(250, 11, 60, 14);
        contentPane.add(lblName);

        lblDepartment = new JLabel("Công Việc");
        lblDepartment.setBounds(416, 11, 86, 14);
        contentPane.add(lblDepartment);

        JLabel l1 = new JLabel("Tuổi");
        l1.setBounds(536, 11, 86, 14);
        contentPane.add(l1);

        JLabel l2 = new JLabel("SĐT");
        l2.setBounds(656, 11, 86, 14);
        contentPane.add(l2);

        JLabel l3 = new JLabel("Lương");
