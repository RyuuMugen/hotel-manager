...
public class AddRoom extends JFrame implements ActionListener{
    ...
    public AddRoom() {
        ...
        ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("btljava/icons/twelve.jpg"));
        ...
        JLabel l10 = new JLabel("Thêm Phòng");
        ...
        comboBox = new JComboBox(new String[] { "Chưa Đặt", "Đã Đặt" });
        comboBox.setBounds(176, 110, 154, 20);
        contentPane.add(comboBox);


        JLabel l3 = new JLabel("Tình Trạng:");
        l3.setForeground(new Color(25, 25, 112));
        l3.setFont(new Font("Tahoma", Font.BOLD, 14));
        l3.setBounds(64, 150, 102, 22);
        contentPane.add(l3);

        comboBox_2 = new JComboBox(new String[] { "Đã Vệ Sinh", "Chưa Vệ Sinh" });
        comboBox_2.setBounds(176, 150, 154, 20);
        contentPane.add(comboBox_2);

        JLabel l4 = new JLabel("Giá Phòng");
        ...
        JLabel l5 = new JLabel("Loại Phòng");
        ...
        comboBox_3 = new JComboBox(new String[] { "Giường Đơn", "Giường Đôi"});
